...
// Tue Sep 27 17:05:41 2016 by ROOT version 5.34/21
// from TTree EventTree/Event data (tag V08_00_10_00)
// found on file: ggtree_mc_DYJets_1396.root
//////////////////////////////////////////////////////////
...
#ifdef dyjets_cxx
dyjets::dyjets(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ggtree_mc_DYJets_1396.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ggtree_mc_DYJets_1396.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ggtree_mc_DYJets_1396.root:/ggNtuplizer");
...
Int_t dyjets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dyjets::LoadTree(Long64_t entry)
{
...
void dyjets::Show(Long64_t entry)
{
...
Int_t dyjets::Cut(Long64_t entry)
{
